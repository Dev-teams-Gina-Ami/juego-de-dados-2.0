    ...
    export class GameRepositoriesImpl implements GameRepository {
        ...
        getGameData(game: Game) : GameMap {
            return {
                ...
                has_won: game.result?.win || false, //valor por defecto por si no hay valor
                dice1_value: game.result?.rolls[0] || 0, //valor por defecto por si no hay valor
                dice2_value: game.result?.rolls[1] || 0 //valor por defecto por si no hay valor
            }
        }
